"main";/*{"e":{"default":1},"m":{"postcss":["default"],"postcss-value-parser":["default"]},"s":[],"w":null}*/let postcss;_ef3‍.w('postcss',[["default",function(v){postcss=v}]]);let valueParser;_ef3‍.w('postcss-value-parser',[["default",function(v){valueParser=v}]]);
...
_ef3‍.d(postcss.plugin('postcss-font-family-system-ui', () => {
  return (root) => {
    root.walk(transform())
  }
}));
